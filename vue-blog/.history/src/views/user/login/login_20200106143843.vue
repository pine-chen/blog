    ...
    <div class="wrapper">
      ...
      <div class="main">
        ...
        <div class="js-sign-in-container">
          <form id="new_session"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="PLBOfkcKdsUcdOiD6qocQd9ivl0cg0A3/SiAwn5a5v6Ol3G4VuPPjsefuM9D4+oTp15U4VGzmaNZsSsI3MGQaw==">
