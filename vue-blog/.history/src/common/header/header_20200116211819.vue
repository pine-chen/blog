    ...
    <div class="pc-header-show">
      <div class="m-header">
        ...
        <div class="login-register">
          <el-button type="text" size="medium" @click="Dialog(true, 1)">登录</el-button>
          <el-button type="success" size="medium" round @click="showDialog(true, 0)">免费注册</el-button>
        </div>
      </div>
    </div>
  </div>
