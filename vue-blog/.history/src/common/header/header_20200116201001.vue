    ...
    <div class="pc-header-show">
      <div class="m-header">
        ...
        <div class="login-register">
          <el-button type="text" size="medium" @click="Login(); show-dialog(true)">登录</el-button>
          <el-button type="success" size="medium" round @click="Register(); show-dialog(true)">免费注册</el-button>
        </div>
      </div>
    </div>
  </div>
