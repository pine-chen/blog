    ...
    <div class="pc-header-show">
      <div class="m-header">
        ...
        <div class="login-register">
          <el-button type="text" size="medium" @click="Login(1); showDialog(true)">登录</el-button>
          <el-button type="success" size="medium" round @click="Register(); showDialog(true)">免费注册</el-button>
        </div>
      </div>
    </div>
  </div>
