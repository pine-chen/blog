...
router.post('/info', function (req, res, next) {
    ...
    const { photo, nickname, oldPassword, newPassword, age, email, telephone, information } = req.body;
    console.log('photo:', photo)
    const result = userInfo(id, photo, nickname, oldPassword, newPassword, age, email, telephone, information);
    return result.then(data => {
