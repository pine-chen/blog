...
const userInfo = async(id, nickname, oldPassword, newPassword, age, email, telephone, information) => {
    ...
    const sql = `update users set user_nickname=${nickname}, user_password=${newPassword}, user_age=${age}, user_email=${email}, user_=${telephone}, user_info=${information} where user_id=${id} and user_password=${oldPassword};`
