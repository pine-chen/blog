...
const userInfo = async(id, nickname, oldPassword, newPassword, age, email, telephone, information) => {
    ...
    const sql = `update users set user_nickname=${nickname}, user_password=${newPassword}, user_age=${age}, user, user_info=${information} where id=${id} and password=${oldPassword};`
