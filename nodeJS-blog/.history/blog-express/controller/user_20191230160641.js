...
const userInfo = async(id, nickname, oldPassword, newPassword, age, email, information) => {
    nickname = escape(nickname)
    ...
    const sql = `update users set user_nickname=${nickname}, password=${newPassword}, information=${information} where id=${id} and password=${oldPassword};`
